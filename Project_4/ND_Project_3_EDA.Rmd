...
##Dataset Preparation     
```{r echo=FALSE}
setwd("~/Desktop/Udacity_DataAnalyst_ND/Project_4/")
```
...
prop.table(table(Prosper_Post09_Subset$ListingCategory, Prosper_Post09_Subset$ProsperRating), margin=2)
```
...
******* 
```{r echo=FALSE, comment=NA}
univariateInquiresLast6Months <- function(ProsperDataFrame){
...
univariateInquiresLast6Months(Prosper_Post09_Subset)
```
...
print("Number of on time Prosper Payments made 
...
print("Prosper Payments Less Then One Month Late 
      (applies to previous borrowers only)")
...
print("Prosper Payments More Than One Month Late 
      (applies to previous borrowers only)")
...
print("Prosper Principle Borrowers by Previous Borrowers 
      (applies to previous borrowers only)")
